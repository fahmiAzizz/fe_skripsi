...
export default function EmployeeFormEdit({ onCancel, onRefresh, editData }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`http://localhost:4321/v1/userEmployee/${editData.external_id}`, formData, {
                withCredentials: true
            });
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
            <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-lg">
                <h2 className="text-2xl font-semibold text-center text-gray-700 mb-4">Edit Karyawan</h2>
                <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
                    ...
                    <div className="col-span-1">
                        ...
                        <select name="role_name" className="w-full p-2 border rounded-lg" value={formData.role_name} onChange={handleChange}>
                    ...
                    <div className="col-span-2 flex gap-2">
                        <button type="submit" className={`w-full p-2 text-white font-semibold rounded-lg ${loading ? "bg-gray-400" : "bg-green-600 hover:bg-green-700"}`} disabled={loading}>
                            {loading ? "Menyimpan..." : "Update"}
                        </button>
                        <button type="button" onClick={onCancel} className="w-full p-2 text-white font-semibold rounded-lg bg-gray-500 hover:bg-gray-600">
                            Batal
                        </button>
                    </div>
                </form>
